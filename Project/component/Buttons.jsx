...
const Buttons = () => {
	return (
		<div className="flex flex-row justify-around w-full mt-12">
			<div className="flex flex-col p-5 items-center text-center w-64 max-w-xl mx-2 rounded-lg shadow-xl dark:bg-white/10 bg-white/30 ring-1 ring-gray-900/5 backdrop-blur-lg">
				<Link to="/ocr">
					<div>
						<img
